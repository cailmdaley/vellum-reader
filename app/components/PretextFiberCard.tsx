/**
 * PretextFiberCard — Gate 1a experiment for Vellum Workspace.
 *
 ...
 * pretext returns a real measurement. That's intentional for Gate 1a: the
 * whole point is to see what pretext produces, not to paper over it with a
 * CSS fallback.
 */
