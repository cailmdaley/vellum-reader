/**
 * FiberCardWithMedia — Gate 1b fiber card with an east-placed media pane.
 *
 ...
 * `42b4924` (original Gate 1b landing commit). The source of truth for the
 * pre-Vite version lives at
 * `.felt/vellum-vite-migration/pretext-refoundation/reference/FiberCardWithMedia.tsx`.
 */
